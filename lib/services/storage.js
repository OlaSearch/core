...
module.exports = {
  ...
  set: function set(key, value, namespace) {
    try {
      if ('localStorage' in window) window.localStorage.setItem((0, _utilities.getKey)(key, namespace), (0, _stringify2['default'])(value));
    } catch (err) {
      console.warn(err);
      return undefined;
    }
  ...
  cookies: {
    set: function set(name, value, days, namespace) {
      ...
      if ((typeof value === 'undefined' ? 'undefined' : (0, _typeof3['default'])(value)) === 'object') value = encodeURIComponent((0, _stringify2['default'])(value));
      if (days) {
        var date = new Date();
