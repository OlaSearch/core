    ...
    for (var name in params) {
      ...
      if (name === 'filters') {
        value = value.filter(function (item) {
          ...
          if ((typeof selected === 'undefined' ? 'undefined' : (0, _typeof3['default'])(selected)) === 'object') selected = _queryString2['default'].stringify(selected);
    ...
    if (filters) {
      ...
      var filterQuery = filters.map(function (item) {
        var _item$split5 = item.split(':'),
            _item$split6 = (0, _slicedToArray3['default'])(_item$split5, 2),
            name = _item$split6[0],
