...
module.exports = function (WrappedComponent) {
  var OlaRoute = function (_React$Component) {
    ...
    function OlaRoute() {
      ...
      return _ret = (_temp = (_this = require('../../.babelhelper.js').possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(OlaRoute)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onPopState = function () {
        console.log('called');
