...
exports.withTranslate = undefined;
...
var withTranslate = exports.withTranslate = function withTranslate(ComposedComponent) {
  var _class, _temp2;
  ...
  return _temp2 = _class = function (_React$Component) {
    ...
    function _class() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(_class)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onPopState = function () {
        _this.props.dispatch(initSearch({ config: _this.context.config }));
