...
module.exports = function (WrappedComponent) {
  var WithTranslate = function (_React$Component) {
    ...
    function WithTranslate() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(WithTranslate)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.translate = function (key, placeholders, isHTML) {
        var result = (0, _utilities.translateKey)(key, _this.context.translations['messages']);
        if (typeof placeholders === 'undefined') {
          return result;
        }
        return isHTML ? _react2['default'].createElement('div', { dangerouslySetInnerHTML: (0, _utilities.createHTMLMarkup)((0, _utilities.supplant)(result, placeholders)) }) : (0, _utilities.supplant)(result, placeholders);
