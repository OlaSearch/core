...
exports['default'] = function (WrappedComponent) {
  var WithLogger = function (_React$PureComponent) {
    ...
    function WithLogger() {
      ...
      return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.log = function (params) {
        _this.context.store.dispatch((0, _Logger.log)(params));
      }, _temp), (0, _possibleConstructorReturn3['default'])(_this, _ret);
    }

    WithLogger.prototype.render = function render() {
      return _react2['default'].createElement(WrappedComponent, (0, _extends3['default'])({}, this.props, { log: this.log }));
    };
