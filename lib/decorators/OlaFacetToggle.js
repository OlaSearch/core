...
function withFacetToggle(WrappedComponent) {
  var WithFacetToggle = function (_React$Component) {
    (0, _inherits3['default'])(WithFacetToggle, _React$Component);

    function WithFacetToggle(props) {
      (0, _classCallCheck3['default'])(this, WithFacetToggle);

      var _this = (0, _possibleConstructorReturn3['default'])(this, (WithFacetToggle.__proto__ || (0, _getPrototypeOf2['default'])(WithFacetToggle)).call(this, props));
    ...
    (0, _createClass3['default'])(WithFacetToggle, [{
      ...
      value: function render() {
        return _react2['default'].createElement(WrappedComponent, (0, _extends3['default'])({}, this.props, { isCollapsed: this.state.isCollapsed, toggleDisplay: this.toggleDisplay }));
      }
    }]);
