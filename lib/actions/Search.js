    ...
    dispatch({
      ...
      beforeSuccessCallback: function beforeSuccessCallback(response) {
        ...
        return (0, _extends3['default'])({}, response, {
          extra: {
            resultIds: results.map(function (_ref6) {
              var id = _ref6.id;
              return id;
            }),
...
function addFacet(facet, value) {
  return function (dispatch, getState) {
    ...
    var exists = getState().QueryState.facet_query.some(function (_ref7) {
      var name = _ref7.name,
...
function removeFacet(facet, value) {
  ...
  return function (dispatch, getState) {
     ...
     */
    var intentEngineFacets = getState().QueryState.facet_query.filter(function (_ref8) {
      var fromIntentEngine = _ref8.fromIntentEngine,
          isToken = _ref8.isToken;
 ...
 */
function initSearch(_ref10) {
  var config = _ref10.config,
      _ref10$urlSync = _ref10.urlSync,
      urlSync = _ref10$urlSync === undefined ? true : _ref10$urlSync,
