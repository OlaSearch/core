...
function executeFacetSearch() {
  ...
  return function (dispatch, getState) {
    ...
    var facet_query = tokens.map(function (_ref3) {
    ...
    var initialStart = 0;
    var q = removeTokenFromQuery(fullTerm, tokens.map(function (_ref4) {
    ...
    dispatch({
      ...
      processData: function processData(response) {
        ...
        return (0, _extends3['default'])({}, response, {
          extra: {
            resultIds: results.map(function (_ref5) {
              var id = _ref5.id;
              return id;
            }),
...
function addFacet(facet, value) {
  return function (dispatch, getState) {
    ...
    var exists = getState().QueryState.facet_query.some(function (_ref6) {
      var name = _ref6.name,
...
function removeFacet(facet, value) {
  ...
  return function (dispatch) {
    var fromIntentEngine = facet.fromIntentEngine;
 ...
 */
function initSearch(_ref7) {
  var config = _ref7.config,
      _ref7$urlSync = _ref7.urlSync,
      urlSync = _ref7$urlSync === undefined ? true : _ref7$urlSync,
