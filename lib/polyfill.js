...
;(function (undefined) {
  ...
  if (!_iterator2['default']) {
    Object.defineProperty(_symbol2['default'], 'iterator', { value: (0, _symbol2['default'])('iterator') });
  }

  // Symbol.toStringTag
  if (!_toStringTag2['default']) {
    Object.defineProperty(_symbol2['default'], 'toStringTag', {
