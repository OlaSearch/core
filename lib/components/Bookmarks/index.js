...
var _ref = _react2['default'].createElement('span', { className: 'ola-btn-hint hint--top', 'aria-label': 'Bookmarks' });
...
module.exports = (0, _reactRedux.connect)(mapStateToProps)((0, _reactOnclickoutside2['default'])(Bookmarks));