...
var Guide = function (_React$Component) {
  ...
  function Guide() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Guide)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onContinue = function () {
      ...
      dispatch((0, _Guide.replaceFacet)(facet, value));
      ...
      if (idx !== index) {
        ...
        if (idx < index) {
          dispatch((0, _Guide.clearFacetAfterIndex)(idx));
        }
