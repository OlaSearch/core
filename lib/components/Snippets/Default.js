  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(_Bookmark2['default'], (0, _extends3['default'])({
          result: result,
          bookmarks: bookmarks,
          dispatch: dispatch
        }, rest)),
        _react2['default'].createElement(_Title2['default'], (0, _extends3['default'])({ result: result }, rest)),
        _react2['default'].createElement(_TextField2['default'], (0, _extends3['default'])({ result: result, field: 'summary' }, rest))
      )
    )
  );
}
