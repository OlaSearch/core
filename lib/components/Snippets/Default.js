...
var DefaultSnippet = function (_React$Component) {
  _inherits(DefaultSnippet, _React$Component);

  function DefaultSnippet() {
    _classCallCheck(this, DefaultSnippet);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(DefaultSnippet).apply(this, arguments));
  }

  _createClass(DefaultSnippet, [{
    key: 'render',
