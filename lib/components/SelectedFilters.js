        ...
        facets.map(function (facet, idx) {
          ...
          return _react2['default'].createElement(
            ...
            tags.map(function (value, index) {
              return _react2['default'].createElement(SelectedFacetItem, {
                name: value,
                facet: facet,
...
var SelectedFacetItem = function (_React$Component2) {
  require('../../.babelhelper.js').inherits(SelectedFacetItem, _React$Component2);

  function SelectedFacetItem() {
    var _Object$getPrototypeO;

    var _temp, _this3, _ret;

    require('../../.babelhelper.js').classCallCheck(this, SelectedFacetItem);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this3 = require('../../.babelhelper.js').possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SelectedFacetItem)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this3), _this3.handleRemove = function () {
  ...
  require('../../.babelhelper.js').createClass(SelectedFacetItem, [{
    key: 'render',
    value: function render() {
...
var SelectedFilterItem = function (_React$Component3) {
  require('../../.babelhelper.js').inherits(SelectedFilterItem, _React$Component3);
  ...
  function SelectedFilterItem() {
    ...
    require('../../.babelhelper.js').classCallCheck(this, SelectedFilterItem);

    for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
      args[_key2] = arguments[_key2];
    }

    return _ret2 = (_temp2 = (_this4 = require('../../.babelhelper.js').possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(SelectedFilterItem)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this4), _this4.handleRemove = function () {
      _this4.props.handleRemove(_this4.props.filter);
    }, _temp2), require('../../.babelhelper.js').possibleConstructorReturn(_this4, _ret2);
  }

  require('../../.babelhelper.js').createClass(SelectedFilterItem, [{
    key: 'render',
    value: function render() {
