...
var SelectedFacetItem = function (_React$Component2) {
  _inherits(SelectedFacetItem, _React$Component2);
  ...
  function SelectedFacetItem() {
    ...
    _classCallCheck(this, SelectedFacetItem);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SelectedFacetItem)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this3), _this3.handleRemove = function () {
      _this3.props.handleRemove(_this3.props.facet, _this3.props.name);
    }, _temp), _possibleConstructorReturn(_this3, _ret);
  }

  _createClass(SelectedFacetItem, [{
    key: 'render',
    value: function render() {
