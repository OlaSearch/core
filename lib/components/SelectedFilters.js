...
var SelectedFilters = function (_React$Component) {
  ...
  SelectedFilters.prototype.render = function render() {
    ...
    facets = facets.filter(function (_ref, idx) {
      var tab = _ref.tab,
          zone = _ref.zone,
          options = _ref.options;
      return (showTabs ? true : !tab) && (showZones ? true : !zone);
    });
    ...
    return _react2['default'].createElement(
      ...
      facets.map(function (facet, idx) {
        ...
        tags = tags.filter(function (_, idx) {
          return options && options[idx] ? !options[idx].isHidden : true;
        });
...
module.exports = (0, _withConfig2['default'])(SelectedFilters);