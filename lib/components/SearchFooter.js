...
function SearchFooter(props, context) {
  ...
  if (infiniteScrollOverride || infiniteScroll || isPhone) {
    return _react2['default'].createElement(_LoadMore2['default'], (0, _extends3['default'])({}, props, {
      actions: boundActionCreators,
      beforeChangePage: beforeChangePage
    }));
  }

  return _react2['default'].createElement(_Pagination2['default'], (0, _extends3['default'])({}, props, {
    actions: boundActionCreators,
    beforeChangePage: beforeChangePage
  }));
}
