...
var SearchFooter = function (_React$Component) {
	...
	function SearchFooter(props) {
		...
		return _possibleConstructorReturn(this, Object.getPrototypeOf(SearchFooter).call(this, props));
	}
	...
	_createClass(SearchFooter, [{
		...
		value: function render() {
			...
			if (infiniteScroll || isPhone) {
				...
				return _react2.default.createElement(_LoadMore2.default, _extends({}, this.props, { actions: boundActionCreators }));
			}
