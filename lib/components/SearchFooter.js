...
function SearchFooter(props) {
  ...
  var infiniteScroll = config.infiniteScroll;
  ...
  return _react2['default'].createElement(infiniteScrollOverride || infiniteScroll || isPhone ? _LoadMore2['default'] : _Pagination2['default'], (0, _extends3['default'])({}, props, {
    actions: boundActionCreators,
    beforeChangePage: beforeChangePage
  }));
}
module.exports = (0, _withConfig2['default'])(SearchFooter);