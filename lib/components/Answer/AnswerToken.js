  ...
  return _react2['default'].createElement(
    ...
    function (theme) {
      return _react2['default'].createElement(
        'div',
        {
          className: _style2['default'].dynamic([['1460717577', [theme.primaryColor, theme.primaryInvertColor]]]) + ' ' + 'ola-answer-slots'
        },
        _react2['default'].createElement(
          'span',
          {
            className: _style2['default'].dynamic([['1460717577', [theme.primaryColor, theme.primaryInvertColor]]]) + ' ' + 'ola-answer-slots-text'
          },
...
function AnswerTokenBtn(_ref9) {
  ...
  return _react2['default'].createElement(
    ...
    displayName,
    ': ',
    value && type !== _Settings.SLOT_DATE ? value[0] : match,
    _ref10
  );
}
