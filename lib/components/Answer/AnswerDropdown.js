...
var AnswerDropdown = function (_React$Component) {
  ...
  function AnswerDropdown(props) {
    ...
    var _this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (AnswerDropdown.__proto__ || Object.getPrototypeOf(AnswerDropdown)).call(this, props));
...
var AnswerDropdownItem = function (_React$Component2) {
  ...
  function AnswerDropdownItem() {
    ...
    return _ret = (_temp = (_this3 = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref = AnswerDropdownItem.__proto__ || Object.getPrototypeOf(AnswerDropdownItem)).call.apply(_ref, [this].concat(args))), _this3), _this3.handleClick = function () {
