...
var AnswerGrid = function (_React$Component) {
  ...
  function AnswerGrid(props) {
    ...
    var _this = require('../../../.babelhelper.js').possibleConstructorReturn(this, Object.getPrototypeOf(AnswerGrid).call(this, props));
  ...
  require('../../../.babelhelper.js').createClass(AnswerGrid, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        this.state.isOpen ? _react2['default'].createElement(_ListKeyValue2['default'], { data: this.state.selectedAnswer.additional_data }) : null,
