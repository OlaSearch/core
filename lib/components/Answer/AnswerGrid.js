...
var AnswerGrid = function (_React$Component) {
  ...
  AnswerGrid.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    if (nextProps.answer !== this.props.answer) {
      this.hideAnswerCard();
    }
  };

  AnswerGrid.prototype.render = function render() {
    var _this2 = this;
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        data.slice(0, 4).map(function (result, idx) {
          return _react2['default'].createElement(_AnswerCard2['default'], {
            key: result.title,
            cdn: _this2.props.config.cdn,
            imagePlaceholder: _this2.props.config.imagePlaceholder,
            result: result,
      ...
      this.state.isOpen ? _react2['default'].createElement(_ListKeyValue2['default'], {
...
exports['default'] = (0, _withConfig2['default'])(AnswerGrid);