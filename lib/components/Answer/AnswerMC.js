...
var AnswerMC = function (_React$Component) {
  ...
  function AnswerMC() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.createRegex = function (term) {
      ...
      var snippet = answer.snippet,
          ...
          snippetConfidence = answer.snippet_confidence,
  ...
  AnswerMC.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        theme = _props2.theme;
    var _props$config$mcThres = this.props.config.mcThreshold,
        mcThreshold = _props$config$mcThres === undefined ? 0.4 : _props$config$mcThres;
...
module.exports = (0, _reactRedux.connect)(mapStateToProps, { fetchMc: _Search.fetchMc })((0, _withConfig2['default'])((0, _withTheme2['default'])(AnswerMC)));