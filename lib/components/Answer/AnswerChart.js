...
var _TableDetail = require('olasearch/lib/components/Answer/common/TableDetail');
...
var AnswerCharts = function (_React$Component) {
  ...
  function AnswerCharts() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, (_ref = AnswerCharts.__proto__ || (0, _getPrototypeOf2['default'])(AnswerCharts)).call.apply(_ref, [this].concat(args))), _this), _this.sanitize = function (text) {
      if (typeof text !== 'string') return text;
      return text.replace(/<(?:.*|\n)*?>/gm, '');
    }, _this.prepareData = function (props) {
      ...
      var keys = recordKeys.filter(function (key) {
        return key !== 'Country';
      });
      var data = recordData.slice(0, 5).map(function (item) {
        var country = item['Country'];
        return [].concat(country, keys.map(function (key) {
          return key in item ? _this.sanitize(item[key]) : null;
        }));
      });
