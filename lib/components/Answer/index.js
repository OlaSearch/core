...
var _AnswerMC = require('./AnswerMC');
...
function Answer(_ref) {
  ...
  function templatePicker(template, data, module) {
    ...
    switch (template) {
      ...
      case 'text':
        return _react2['default'].createElement(_AnswerGrid2['default'], { data: data, result: result, answer: answer });
  ...
  if (mc) {
    return _react2['default'].createElement(_AnswerMC2['default'], { mc: mc });
  }
