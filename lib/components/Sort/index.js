...
var Sort = function (_React$Component) {
  ...
  function Sort() {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref = Sort.__proto__ || Object.getPrototypeOf(Sort)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (event) {
