...
var RangeNumeric = function (_React$Component) {
  _inherits(RangeNumeric, _React$Component);

  function RangeNumeric() {
    var _Object$getPrototypeO;

    var _temp, _this, _ret;

    _classCallCheck(this, RangeNumeric);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(RangeNumeric)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleClick = function (from, to) {
...
var RangeNumericItem = function (_React$Component2) {
  ...
  _createClass(RangeNumericItem, [{
    ...
    value: function render() {
      ...
      var itemKlass = (0, _classnames2['default'])('ola-btn', 'ola-facet-link', { 'ola-facet-link-active': true });
      return _react2['default'].createElement(
        'div',
        {
          className: itemKlass,
...
module.exports = (0, _OlaFacetToggle.FacetToggle)(RangeNumeric);