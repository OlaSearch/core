...
var RangeNumericFilter = function (_React$Component) {
  ...
  function RangeNumericFilter() {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(RangeNumericFilter)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleClick = function (from, to) {
...
var RangeNumericItem = function (_React$Component2) {
  ...
  function RangeNumericItem() {
    ...
    return _ret2 = (_temp2 = (_this3 = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(RangeNumericItem)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this3), _this3.handleClick = function () {
