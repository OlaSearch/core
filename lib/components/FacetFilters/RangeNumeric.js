...
var RangeNumericFilter = function (_React$Component) {
  ...
  function RangeNumericFilter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RangeNumericFilter.__proto__ || Object.getPrototypeOf(RangeNumericFilter)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (from, to) {
...
var RangeNumericItem = function (_React$Component2) {
  ...
  function RangeNumericItem() {
    ...
    return _ret2 = (_temp2 = (_this3 = _possibleConstructorReturn(this, (_ref2 = RangeNumericItem.__proto__ || Object.getPrototypeOf(RangeNumericItem)).call.apply(_ref2, [this].concat(args))), _this3), _this3.handleClick = function () {
