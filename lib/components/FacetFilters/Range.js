...
var RangeFilter = function (_React$Component) {
  ...
  function RangeFilter() {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref = RangeFilter.__proto__ || Object.getPrototypeOf(RangeFilter)).call.apply(_ref, [this].concat(args))), _this), _this.onChange = function (value) {
      ...
      var _value = value,
          _value2 = require('../../../.babelhelper.js').slicedToArray(_value, 2),
          start = _value2[0],
          end = _value2[1];
  ...
  require('../../../.babelhelper.js').createClass(RangeFilter, [{
    ...
    value: function componentDidUpdate() {
      ...
      var _props$facet = this.props.facet,
          _props$facet$interval = _props$facet.interval,
          interval = _props$facet$interval === undefined ? 1 : _props$facet$interval,
      ...
      var step = dateFormat ? 1 : parseInt(interval);
    ...
    value: function getSliderValues(props) {
       ...
       */
      selected = selected.map(function (values) {
    ...
    value: function componentDidMount() {
      ...
      var _facet$interval = facet.interval,
          interval = _facet$interval === undefined ? 1 : _facet$interval,
          singleHandle = facet.singleHandle,
          dateFormat = facet.dateFormat;
