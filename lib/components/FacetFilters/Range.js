...
var Range = function (_React$Component) {
  ...
  function Range() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Range)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onChange = function (value) {
    ...
    value: function componentDidMount() {
      ...
      var formatTooltip = {
        to: function to(value) {
          return type === 'daterange' ? _dateParser2['default'].format(value, dateFormat) : value;
        }
      };
