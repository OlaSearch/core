...
var RangeFilter = function (_React$Component) {
  ...
  function RangeFilter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RangeFilter.__proto__ || Object.getPrototypeOf(RangeFilter)).call.apply(_ref, [this].concat(args))), _this), _this.onChange = function (value) {
  ...
  _createClass(RangeFilter, [{
    ...
    value: function componentDidMount() {
      ...
      this.slider = _nouislider2['default'].create(this.sliderInput, _extends({}, sliderOptions, pipsOptions)
