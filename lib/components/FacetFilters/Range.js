    ...
    */
		...
		value: function getSliderValues(props) {
			...
			if (values.length) {
				...
				min = (_Math = Math).min.apply(_Math, _toConsumableArray(values));
				max = (_Math2 = Math).max.apply(_Math2, _toConsumableArray(values));
			}
...
exports.default = (0, _OlaFacetToggle.FacetToggle)(Range);