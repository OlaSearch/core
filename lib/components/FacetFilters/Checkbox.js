            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(_reactList2['default'], {
                itemRenderer: function itemRenderer(index, key) {
                  ...
                  var isActive = _this2.isSelected(name);
                  ...
                  return _react2['default'].createElement(CheckBoxItem, {
                    ...
                    name: name,
                    count: count,
                    handleAddFacet: _this2.handleAddFacet,
                    handleRemoveFacet: _this2.handleRemoveFacet,
                    isActive: isActive
                  });
                },
                length: size,
...
var CheckBoxItem = function (_React$Component2) {
  ...
  function CheckBoxItem() {
    ...
    return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(CheckBoxItem)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this3), _this3.onChecked = function (event) {
      var _this3$props = _this3.props;
      var facet = _this3$props.facet;
      var name = _this3$props.name;
      var handleAddFacet = _this3$props.handleAddFacet;
      var handleRemoveFacet = _this3$props.handleRemoveFacet;
