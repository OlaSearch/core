...
var CheckBoxItem = function (_React$Component2) {
  ...
  function CheckBoxItem() {
    ...
    return _ret = (_temp = (_this2 = (0, _possibleConstructorReturn3['default'])(this, (_ref = CheckBoxItem.__proto__ || (0, _getPrototypeOf2['default'])(CheckBoxItem)).call.apply(_ref, [this].concat(args))), _this2), _this2.onChecked = function (event) {
