  ...
  (0, _createClass3['default'])(CheckboxFilter, [{
    ...
    value: function render() {
      ...
      if (fixedValues && fixedValues.length) {
         ...
         */
        var selectedValue = [].concat((0, _toConsumableArray3['default'])(defaultValue.map(function (item) {
          return item.replace(/(-)/gi, '');
        })), (0, _toConsumableArray3['default'])(fixedValues));
...
module.exports = (0, _OlaTranslate2['default'])((0, _OlaToggle2['default'])(CheckboxFilter));