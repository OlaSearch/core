...
var LinkFilter = function (_React$Component) {
  ...
  function LinkFilter(props) {
    ...
    var _this = require('../../../.babelhelper.js').possibleConstructorReturn(this, Object.getPrototypeOf(LinkFilter).call(this, props));
  ...
  require('../../../.babelhelper.js').createClass(LinkFilter, [{
    ...
    value: function render() {
      ...
      var showIfEmpty = _props.showIfEmpty;
      var showSelectedFacetItem = _props.showSelectedFacetItem;
      var values = facet.values;
      var _facet$showSelectedTa = facet.showSelectedTag;
      var showSelectedTag = _facet$showSelectedTa === undefined ? true : _facet$showSelectedTa;
      var removeLabel = facet.removeLabel;
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          filterInput,
          showSelectedTag ? _react2['default'].createElement(
            'div',
...
var Item = function (_React$Component2) {
  ...
  function Item() {
    ...
    return _ret = (_temp = (_this3 = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Item)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this3), _this3.handleClick = function () {
...
var SelectedItem = function (_React$Component3) {
  ...
  function SelectedItem() {
    ...
    return _ret2 = (_temp2 = (_this4 = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(SelectedItem)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this4), _this4.handleRemove = function () {
  ...
  require('../../../.babelhelper.js').createClass(SelectedItem, [{
    ...
    value: function render() {
      ...
      var buttonLabel = _props3.buttonLabel;
