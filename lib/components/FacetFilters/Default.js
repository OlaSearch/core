...
var LinkFilter = function (_React$Component) {
  _inherits(LinkFilter, _React$Component);

  function LinkFilter(props) {
    _classCallCheck(this, LinkFilter);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LinkFilter).call(this, props));
  ...
  _createClass(LinkFilter, [{
    ...
    value: function render() {
      ...
      var showMoreText = translate('facet_filter_showmore');
      var showLessText = translate('facet_filter_showless');
...
var SelectedItem = function (_React$Component3) {
  ...
  function SelectedItem() {
    ...
    return _ret2 = (_temp2 = (_this4 = _possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(SelectedItem)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this4), _this4.handleRemove = function () {
