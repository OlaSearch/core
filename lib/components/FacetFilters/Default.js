            ...
            selected.map(function (item, idx) {
              return _react2['default'].createElement(_Tag2['default'], {
                onRemove: function onRemove() {
                  return _this2.handleRemoveFacat(facet, item);
                },
                name: item,
                facet: facet,
                key: idx
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(_reactList2['default'], {
                itemRenderer: function itemRenderer(index, key) {
                  ...
                  var itemKlass = (0, _classnames2['default'])('ola-btn', 'ola-facet-link', { 'ola-facet-link-active': isSelected(name) });
                  ...
                  return _react2['default'].createElement(
                    'button',
                    {
                      ...
                      onClick: function onClick() {
                        !isSelected(name) && _this2.handleAddFacet(facet, name);
                      }
                    },
                    _react2['default'].createElement(
                      'span',
