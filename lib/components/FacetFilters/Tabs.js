...
var TabsFilter = function (_React$Component) {
  ...
  function TabsFilter() {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref = TabsFilter.__proto__ || Object.getPrototypeOf(TabsFilter)).call.apply(_ref, [this].concat(args))), _this), _this.handleReplaceFacet = function (facet, value) {
      /**
...
var TabItemAll = function (_React$Component2) {
  ...
  function TabItemAll() {
    ...
    return _ret3 = (_temp2 = (_this3 = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref2 = TabItemAll.__proto__ || Object.getPrototypeOf(TabItemAll)).call.apply(_ref2, [this].concat(args))), _this3), _this3.handleClick = function () {
      if (!_this3.props.isSelected) _this3.props.handleClick(_this3.props.facet);
    }, _temp2), require('../../../.babelhelper.js').possibleConstructorReturn(_this3, _ret3);
  }
...
var TabItem = function (_React$Component3) {
  ...
  function TabItem() {
    ...
    return _ret4 = (_temp3 = (_this4 = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref3 = TabItem.__proto__ || Object.getPrototypeOf(TabItem)).call.apply(_ref3, [this].concat(args))), _this4), _this4.handleClick = function () {
    ...
    }, _temp3), require('../../../.babelhelper.js').possibleConstructorReturn(_this4, _ret4);
  }
