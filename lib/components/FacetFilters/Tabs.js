...
var TabItemAll = function (_React$Component2) {
  (0, _inherits3['default'])(TabItemAll, _React$Component2);
  ...
  function TabItemAll() {
    ...
    (0, _classCallCheck3['default'])(this, TabItemAll);

    for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
      args[_key2] = arguments[_key2];
    }

    return _ret3 = (_temp2 = (_this3 = (0, _possibleConstructorReturn3['default'])(this, (_ref2 = TabItemAll.__proto__ || (0, _getPrototypeOf2['default'])(TabItemAll)).call.apply(_ref2, [this].concat(args))), _this3), _this3.handleClick = function () {
      if (!_this3.props.isSelected) _this3.props.handleClick(_this3.props.facet);
    }, _temp2), (0, _possibleConstructorReturn3['default'])(_this3, _ret3);
  }

  (0, _createClass3['default'])(TabItemAll, [{
    key: 'render',
    value: function render() {
      ...
      return _react2['default'].createElement(
        'a',
        { className: klassTab, onClick: this.handleClick },
        label,
...
var TabItem = function (_React$Component3) {
  (0, _inherits3['default'])(TabItem, _React$Component3);
  ...
  function TabItem() {
    ...
    return _ret4 = (_temp3 = (_this4 = (0, _possibleConstructorReturn3['default'])(this, (_ref3 = TabItem.__proto__ || (0, _getPrototypeOf2['default'])(TabItem)).call.apply(_ref3, [this].concat(args))), _this4), _this4.handleClick = function () {
      var _this4$props = _this4.props,
          facet = _this4$props.facet,
    ...
    }, _temp3), (0, _possibleConstructorReturn3['default'])(_this4, _ret4);
  }
  ...
  (0, _createClass3['default'])(TabItem, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        'a',
        { className: klass, type: 'button', onClick: this.handleClick },
        _react2['default'].createElement(
          'span',
