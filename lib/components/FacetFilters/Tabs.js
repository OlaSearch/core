        ...
        _react2['default'].createElement(
          'a',
          {
            ...
            onClick: function onClick() {
              if (!isAllSelected) _this2.handleRemoveFacet(tab);
            }
          },
          'All',
          _react2['default'].createElement(
        ...
        tabs.map(function (value, idx) {
          ...
          return _react2['default'].createElement(
            'a',
            {
              ...
              key: idx,
              onClick: function onClick() {
                if (!isActive && value.count) _this2.handleReplaceFacet(tab, value.name);
              } },
            _react2['default'].createElement(
              'span',
              { className: 'ola-tab-name' },
              (0, _utilities.getDisplayName)(facetNames, value.name)
            ),
            _react2['default'].createElement(
              'span',
              { className: 'ola-search-facet-count' },
