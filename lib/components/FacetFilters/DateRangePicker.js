...
var DateLabel = function (_React$Component2) {
  ...
  function DateLabel() {
    ...
    return _ret = (_temp = (_this3 = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref3 = DateLabel.__proto__ || Object.getPrototypeOf(DateLabel)).call.apply(_ref3, [this].concat(args))), _this3), _this3.handleClick = function () {
