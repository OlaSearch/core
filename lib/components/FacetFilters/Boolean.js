...
var FacetBoolean = function (_React$Component) {
  ...
  function FacetBoolean() {
    ...
    _classCallCheck(this, FacetBoolean);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(FacetBoolean)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onChange = function (facet, event) {
      ...
      if (event.target.checked) {
        ...
        dispatch((0, _Search.removeFacet)(facet, 'true'));
      }
...
module.exports = (0, _OlaFacetToggle.FacetToggle)(FacetBoolean);