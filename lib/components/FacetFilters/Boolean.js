...
var BooleanFilter = function (_React$Component) {
  _inherits(BooleanFilter, _React$Component);
  ...
  function BooleanFilter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(BooleanFilter)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onChange = function (event) {
      var _this$props = _this.props;
      var dispatch = _this$props.dispatch;
      var facet = _this$props.facet;


      if (event.target.checked) dispatch((0, _Search.replaceFacet)(facet, 'true'));else dispatch((0, _Search.removeFacet)(facet));
...
module.exports = (0, _OlaFacetToggle.facetToggle)(BooleanFilter);