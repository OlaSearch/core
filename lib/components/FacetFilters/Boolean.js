...
var BooleanFilter = function (_React$Component) {
  ...
  function BooleanFilter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BooleanFilter.__proto__ || Object.getPrototypeOf(BooleanFilter)).call.apply(_ref, [this].concat(args))), _this), _this.onChange = function (event) {
