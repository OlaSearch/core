...
var DateRange = function (_React$Component) {
  ...
  DateRange.prototype.render = function render() {
    ...
    var fromDate = _dateParser2['default'].parse(this.state.fromDate, this.getDateFormat());
    var toDate = _dateParser2['default'].parse(this.state.toDate, this.getDateFormat());
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                isPhone ? _react2['default'].createElement('input', {
                  type: 'date',
                  value: _dateParser2['default'].format(fromDate, _Settings.DATE_FORMAT_MOBILE),
                  onChange: this.onMobileFromChange,
                  max: _dateParser2['default'].format(toDate, _Settings.DATE_FORMAT_MOBILE)
                }) : _react2['default'].createElement(_reactPikadayDatepicker2['default'], {
                  format: _Settings.DEFAULT_DATE_FORMAT,
                  onChange: this.onFromChange,
                  parse: this.parseDate,
                  toString: this.toDateString,
                  value: fromDate,
                  yearRange: _Settings.DATEPICKER_YEAR_RANGE,
                  maxDate: toDate
                })
              ),
              _react2['default'].createElement(
                ...
                isPhone ? _react2['default'].createElement('input', {
                  type: 'date',
                  value: _dateParser2['default'].format(toDate, _Settings.DATE_FORMAT_MOBILE),
                  onChange: this.onMobileToChange,
                  max: _dateParser2['default'].format(fromDate, _Settings.DATE_FORMAT_MOBILE)
                }) : _react2['default'].createElement(_reactPikadayDatepicker2['default'], {
                  format: _Settings.DEFAULT_DATE_FORMAT,
                  parse: this.parseDate,
                  toString: this.toDateString,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getDateFormat = function () {
    return _this3.props.isPhone ? _Settings.DATE_FORMAT_MOBILE : _Settings.DEFAULT_DATE_FORMAT;
  };
...
exports['default'] = (0, _reactRedux.connect)(mapStateToProps, null)((0, _withToggle2['default'])(DateRange));