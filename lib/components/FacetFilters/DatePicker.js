              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  isPhone ? _react2['default'].createElement('input', {
                    ...
                    max: _dateParser2['default'].format(toDate, DATE_FORMAT_MOBILE)
                ...
                _react2['default'].createElement(
                  ...
                  isPhone ? _react2['default'].createElement('input', {
                    type: 'date',
                    value: _dateParser2['default'].format(toDate, DATE_FORMAT_MOBILE),
                    onChange: this.onMobileToChange,
                    max: _dateParser2['default'].format(fromDate, DATE_FORMAT_MOBILE)
                  }) : _react2['default'].createElement(_reactPikadayDatepicker2['default'], {
                    format: DATE_FORMAT,
                    parse: this.parseDate,
                    toString: this.toDateString,
...
module.exports = (0, _reactRedux.connect)(mapStateToProps, null)((0, _OlaToggle2['default'])(DateRange));