...
var _reactPikadayComponent = require('react-pikaday-component');
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_reactPikadayComponent2['default'], {
                    ...
                    value: _dateParser2['default'].parse(this.state.fromDate, DATE_FORMAT)
                  })
                ),
                _react2['default'].createElement(
                  'div',
                  ...
                  _react2['default'].createElement(_reactPikadayComponent2['default'], {
                    ...
                    value: _dateParser2['default'].parse(this.state.toDate, DATE_FORMAT)
                  })
                )
              )
            )
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onCustomChange = function () {
    var fromDate = _dateParser2['default'].toUTC(_this3.state.fromDate, DATE_FORMAT);
    var toDate = _dateParser2['default'].toUTC(_this3.state.toDate, DATE_FORMAT);
  ...
  this.onFromChange = function (date) {
    _this3.setState({
  ...
  this.format = function (date) {
    return _dateParser2['default'].format(_dateParser2['default'].parse(date), DATE_FORMAT);
  };
  ...
  this.parseDate = function (dateString, format) {
  ...
  this.toDateString = function (date, format) {
    return _dateParser2['default'].format(date, DATE_FORMAT);
  };
};
