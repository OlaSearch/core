...
var RatingFilter = function (_React$Component) {
  ...
  function RatingFilter() {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref = RatingFilter.__proto__ || Object.getPrototypeOf(RatingFilter)).call.apply(_ref, [this].concat(args))), _this), _this.handleFacet = function (event) {
