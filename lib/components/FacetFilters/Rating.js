...
var RatingFilter = function (_React$Component) {
  (0, _inherits3['default'])(RatingFilter, _React$Component);
  ...
  function RatingFilter() {
    ...
    (0, _classCallCheck3['default'])(this, RatingFilter);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, (_ref = RatingFilter.__proto__ || (0, _getPrototypeOf2['default'])(RatingFilter)).call.apply(_ref, [this].concat(args))), _this), _this.handleFacet = function (event) {
  ...
  (0, _createClass3['default'])(RatingFilter, [{
    key: 'render',
