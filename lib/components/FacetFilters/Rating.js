...
var RatingFilter = function (_React$Component) {
  ...
  function RatingFilter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(RatingFilter)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleFacet = function (event) {
...
module.exports = (0, _OlaFacetToggle.facetToggle)(RatingFilter);