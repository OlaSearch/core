...
var TagCloud = function (_React$Component) {
  ...
  function TagCloud() {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref = TagCloud.__proto__ || Object.getPrototypeOf(TagCloud)).call.apply(_ref, [this].concat(args))), _this), _this.handleAddFacet = function (value) {
...
var TagCloudItem = function (_React$Component2) {
  ...
  function TagCloudItem() {
    ...
    return _ret2 = (_temp2 = (_this3 = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref2 = TagCloudItem.__proto__ || Object.getPrototypeOf(TagCloudItem)).call.apply(_ref2, [this].concat(args))), _this3), _this3.handleClick = function () {
