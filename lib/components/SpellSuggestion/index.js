...
function SpellSuggestion(props) {
  function onChange(term) {
    ...
    /* Remove any tokens */
    dispatch((0, _Search.removeAllTokens)());
    /* Do a search */
...
SpellSuggestion.defaultProps = {
  ...
  return _react2['default'].createElement(
    'button',
    { type: 'button', className: 'ola-spell-links', onClick: onClick },
    _react2['default'].createElement(
      'span',
...
module.exports = (0, _withTranslate2['default'])(SpellSuggestion);