...
var SpellSuggestion = function (_React$Component) {
  ...
  function SpellSuggestion() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SpellSuggestion.__proto__ || Object.getPrototypeOf(SpellSuggestion)).call.apply(_ref, [this].concat(args))), _this), _this.onChange = function (term) {
