...
var HistoryContainer = (0, _reactRedux.connect)(mapStateToProps)((0, _withTranslate2['default'])((0, _reactOnclickoutside2['default'])(History)));
var HistoryWrapper = function HistoryWrapper(props) {
  var _props$config = props.config,
      searchHistory = _props$config.searchHistory,
      searchPageUrl = _props$config.searchPageUrl;
...
module.exports = (0, _withConfig2['default'])(HistoryWrapper);