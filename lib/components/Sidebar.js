    ...
    return _react2['default'].createElement(
      ...
      function (theme) {
        return _react2['default'].createElement(
          'div',
          {
            className: _style2['default'].dynamic([['3123756595', [theme.primaryButtonBackground, theme.primaryButtonColor, theme.primaryColor, theme.mediumFontSize, theme.defaultFontSize]]]) + ' ' + 'ola-sidebar'
          },
