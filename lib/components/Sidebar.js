    ...
    return _react2['default'].createElement(
      ...
      function (theme) {
        return _react2['default'].createElement(
          'div',
          {
            className: _style2['default'].dynamic([['388057864', [theme.primaryButtonBackground, theme.primaryButtonColor, theme.primaryColor]]]) + ' ' + 'ola-sidebar'
          },
          isSidebarOpen && children,
          _ref,
          _react2['default'].createElement(_style2['default'], {
            styleId: '388057864',
            css: '.ola-sidebar.__jsx-style-dynamic-selector .ola-close-sidebar{background:' + theme.primaryButtonBackground + ';color:' + theme.primaryButtonColor + ';}.ola-sidebar.__jsx-style-dynamic-selector .ola-facet-link{color:' + theme.primaryColor + ';}',
            dynamic: [theme.primaryButtonBackground, theme.primaryButtonColor, theme.primaryColor]
          })
        );
      }
    );
