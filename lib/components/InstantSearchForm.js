 ...
 *
 */
var _ref = _react2['default'].createElement(_materialSearch2['default'], null);
...
var InstantSearchForm = function (_React$Component) {
  ...
  InstantSearchForm.prototype.render = function render() {
    ...
    var classes = (0, _classnames2['default'])('ola-search-form', this.props.className, {
    ...
    return _react2['default'].createElement(
      'form',
      { onSubmit: this.onSubmit, className: _style2['default'].dynamic([['3265937639', [this.props.theme.primaryColor, this.props.theme.primaryColor, theme.primaryColor]]]) + ' ' + (classes || '')
      },
      _react2['default'].createElement(
        'div',
        {
          className: _style2['default'].dynamic([['3265937639', [this.props.theme.primaryColor, this.props.theme.primaryColor, theme.primaryColor]]]) + ' ' + 'ola-search-form-container'
        },
        _react2['default'].createElement(
          'div',
          {
            className: _style2['default'].dynamic([['3265937639', [this.props.theme.primaryColor, this.props.theme.primaryColor, theme.primaryColor]]]) + ' ' + 'ola-form-input-wrapper'
          },
          ...
          _react2['default'].createElement('input', {
            ...
            className: _style2['default'].dynamic([['3265937639', [this.props.theme.primaryColor, this.props.theme.primaryColor, theme.primaryColor]]]) + ' ' + 'ola-text-input'
          }),
        ...
        _react2['default'].createElement(
          'button',
          {
            ...
            'aria-label': 'Submit',
            className: _style2['default'].dynamic([['3265937639', [this.props.theme.primaryColor, this.props.theme.primaryColor, theme.primaryColor]]]) + ' ' + 'ola-search-button'
          },
          _ref
        )
      ),
      _react2['default'].createElement(_style2['default'], {
        styleId: '3265937639',
        css: '.ola-search-button.__jsx-style-dynamic-selector,.ola-search-button.__jsx-style-dynamic-selector:hover,.ola-search-button.__jsx-style-dynamic-selector:active,.ola-search-button.__jsx-style-dynamic-selector:focus{background:' + this.props.theme.primaryColor + ';border-color:' + this.props.theme.primaryColor + ';}.ola-search-focus.__jsx-style-dynamic-selector .ola-search-form-container{border-color:' + theme.primaryColor + ';box-shadow:none;}',
        dynamic: [this.props.theme.primaryColor, this.props.theme.primaryColor, theme.primaryColor]
      })
    );
  };
...
})((0, _withTheme2['default'])((0, _withConfig2['default'])((0, _withTranslate2['default'])(InstantSearchForm))));