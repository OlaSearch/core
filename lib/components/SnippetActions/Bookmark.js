...
var BookmarkActions = function (_React$Component) {
  ...
  function BookmarkActions() {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref = BookmarkActions.__proto__ || Object.getPrototypeOf(BookmarkActions)).call.apply(_ref, [this].concat(args))), _this), _this.addBookmark = function () {
