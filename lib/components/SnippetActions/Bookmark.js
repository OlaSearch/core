...
var _bookmark = require('@olasearch/icons/lib/bookmark');
...
var _ref = _react2['default'].createElement(_bookmark2['default'], { fill: 'currentColor' });

var _ref2 = _react2['default'].createElement(_bookmark2['default'], null);
...
var BookmarkWrapper = function BookmarkWrapper(_ref3) {
  var config = _ref3.config,
      rest = (0, _objectWithoutProperties3['default'])(_ref3, ['config']);

  if (!config.bookmarking) return null;
  return _react2['default'].createElement(BookmarkActions, rest);
};

module.exports = (0, _withConfig2['default'])((0, _withTranslate2['default'])(BookmarkWrapper));