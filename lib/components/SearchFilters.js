...
var SearchFilters = function (_React$Component) {
  ...
  SearchFilters.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
  ...
  SearchFilters.prototype.render = function render() {
    ...
    if (conditional) {
      ...
      facets = (0, _utilities.getFacetsToDisplay)(selected, facets, this.props.config.facetsToDisplay);
    }
...
module.exports = (0, _withConfig2['default'])(SearchFilters);