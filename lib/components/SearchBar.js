...
function SearchBar(_ref) {
  var instantSearch = _ref.instantSearch,
      props = (0, _objectWithoutProperties3['default'])(_ref, ['instantSearch']);
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      ...
      instantSearch ? _ref2 : _react2['default'].createElement(_AutoComplete2['default'], props),
      _ref3,
      _ref4
    )
  );
