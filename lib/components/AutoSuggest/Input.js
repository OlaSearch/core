...
var _ref2 = _react2['default'].createElement(_Bookmarks2['default'], null);

var _ref3 = _react2['default'].createElement(_History2['default'], null);
...
var Input = function (_React$Component) {
  ...
  function Input() {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref = Input.__proto__ || Object.getPrototypeOf(Input)).call.apply(_ref, [this].concat(args))), _this), _this.onClear = function (event) {
