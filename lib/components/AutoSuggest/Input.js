...
var Input = function (_React$Component) {
	...
	_createClass(Input, [{
		...
		value: function render() {
			...
			var button = q ? _react2.default.createElement('button', { type: 'reset', className: 'ola-btn ola-clear-button', onClick: this.onClear }) : _react2.default.createElement('div', { className: 'ola-btn ola-search-button', onClick: function onClick() {
