...
var Input = function (_React$Component) {
	...
	function Input(props) {
		...
		_this.onFocus = function (event) {
			...
			_this.props.onFocus.call(_this, event);
	...
	_createClass(Input, [{
		...
		value: function render() {
			...
			var button = q ? _react2.default.createElement('button', { type: 'reset', className: 'ola-clear-button', onClick: this.onClear }) : _react2.default.createElement('button', { type: 'submit', className: 'ola-search-button', onClick: onSubmit });
