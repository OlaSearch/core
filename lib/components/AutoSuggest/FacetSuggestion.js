...
var FacetSuggestion = function (_React$Component) {
  ...
  function FacetSuggestion() {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref = FacetSuggestion.__proto__ || Object.getPrototypeOf(FacetSuggestion)).call.apply(_ref, [this].concat(args))), _this), _this.onItemClick = function (facet, name) {
...
var FacetSuggestionItem = function (_React$Component2) {
  ...
  function FacetSuggestionItem() {
    ...
    return _ret2 = (_temp2 = (_this3 = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_ref2 = FacetSuggestionItem.__proto__ || Object.getPrototypeOf(FacetSuggestionItem)).call.apply(_ref2, [this].concat(args))), _this3), _this3.handleClick = function () {
