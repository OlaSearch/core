...
var AutoSuggest = function (_React$Component) {
	...
	function AutoSuggest(props) {
		...
		_this.onMove = function (direction) {
			...
			var next = undefined;
			var clearActive = function clearActive(nodes) {
			...
			(0, _domScrollIntoView2['default'])(next, suggestionsContainer, { onlyScrollIfNeeded: true });
		};
		...
		_this.handleViewAll = function () {
			...
			window.location.href = searchPageUrl + '?' + (0, _urlSync.buildQueryString)({ q: q, facet_query: facet_query });
		};
		...
		_this.onBlur = function (event) {
			...
			_this.props.onBlur && _this.props.onBlur.call(_this, event);
		};
	...
	_createClass(AutoSuggest, [{
		...
		value: function render() {
			...
			var klassContainer = (0, _classnames2['default'])('ola-autosuggest', {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'a',
							{ className: viewAllClassName, onClick: this.handleViewAll },
							'View all results'
						)
					)
				)
