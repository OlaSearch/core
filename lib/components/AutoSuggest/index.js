  ...
  function AutoSuggest(props) {
    ...
    _this.onChange = function (term) {
      ...
      if (allowedCharacters && !(0, _utilities.checkForAllowedCharacters)(term, allowedCharacters)) {
        ...
        dispatch((0, _AutoSuggest.executeAutoSuggest)(_this.props.isFuzzySuggest));
      }
    };
      ...
      switch (direction) {
        case 'up':
          ...
          if (index < 0) {
            ...
            if (index === -1) dispatch((0, _AutoSuggest.clearTempQueryTerm)());
          } else {
        ...
        case 'down':
          ...
          if (index >= nodes.length) {
            dispatch((0, _AutoSuggest.clearTempQueryTerm)());
            _this.clearActiveClass(nodes, activeClassName);
          } else {
            next.classList.add(activeClassName);
          }
