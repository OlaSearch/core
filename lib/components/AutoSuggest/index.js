...
var AutoSuggest = function (_React$Component) {
  ...
  function AutoSuggest(props) {
     ...
     * Invariants
     */
    var showFacetSuggestions = props.showFacetSuggestions;
    var facetSuggestionName = props.facetSuggestionName;

    showFacetSuggestions && (0, _invariant2['default'])(facetSuggestionName, 'facetSuggestionName is not defined');
    return _this;
  }
