...
var SUGGESTION_TERM_KEY = 'suggestion';
...
var AutoSuggest = function (_React$Component) {
  ...
  function AutoSuggest(props) {
    ...
    _this.handleClickOutside = function (event) {
      if (_this.props.AutoSuggest.isOpen) {
         ...
         */
        if (event && event.nativeEvent && event.nativeEvent.type === 'keydown' && _this.props.isFuzzySuggest) {
          _this.props.dispatch((0, _AutoSuggest.clearFuzzyQueryTerm)());
        }
      }
      _this.onBlur();
    };
    ...
    _this.onChange = function (term, searchInput) {
      ...
      var isFuzzySuggest = _this$props.isFuzzySuggest;
      ...
      if (allowedCharacters && !(0, _utilities.checkForAllowedCharacters)(term, allowedCharacters)) {
        ...
        if (isFuzzySuggest) dispatch((0, _AutoSuggest.executeFuzzyAutoSuggest)());else dispatch((0, _AutoSuggest.executeAutoSuggest)());
      }
    };
    ...
    _this.onKeyDown = function (direction) {
      ...
      switch (direction) {
        case 'up':
          ...
          if (index < 0) {
            ...
            if (index === -1 && isFuzzySuggest) dispatch((0, _AutoSuggest.clearFuzzyQueryTerm)());
          } else {
        ...
        case 'down':
          ...
          if (index >= nodes.length) {
            isFuzzySuggest && dispatch((0, _AutoSuggest.clearFuzzyQueryTerm)());
            _this.clearActiveClass(nodes, activeClassName);
          } else {
            next.classList.add(activeClassName);
          }
      ...
      if (_this.props.isFuzzySuggest) {
        var term = _this.props.AutoSuggest.results[index] ? _this.props.AutoSuggest.results[index][SUGGESTION_TERM_KEY] : null;
        term && _this.props.dispatch((0, _AutoSuggest.updateFuzzyQueryTerm)(term));
      }
  ...
  require('../../../.babelhelper.js').createClass(AutoSuggest, [{
    ...
    value: function render() {
      ...
      var fuzzyQuery = AutoSuggest.fuzzyQuery;
