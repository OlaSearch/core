    ...
    return _react2['default'].createElement(
      ...
      function (theme) {
        return _react2['default'].createElement(
          'div',
          {
            className: _style2['default'].dynamic([['617142111', [theme.searchLinkColor, theme.searchLinkHoverColor, theme.primaryButtonColor, theme.primaryButtonBackground, theme.shareButtonColor, theme.shareButtonBackground, theme.primaryColor, theme.primaryColor]]]) + ' ' + (klass || '')
          },
