...
var SearchResults = function (_React$Component) {
  ...
  function SearchResults() {
    ...
    return require('../../../.babelhelper.js').possibleConstructorReturn(this, (SearchResults.__proto__ || Object.getPrototypeOf(SearchResults)).apply(this, arguments));
  }
  ...
  require('../../../.babelhelper.js').createClass(SearchResults, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = require('../../../.babelhelper.js').objectWithoutProperties(_props, ['results', 'className', 'snippet']);
