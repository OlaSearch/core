...
var SearchResults = function (_React$Component) {
	...
	_createClass(SearchResults, [{
		...
		value: function render() {
			...
			var props = _objectWithoutProperties(_props, ['results', 'category']);
			...
			var categories = (0, _ramda.flatten)(category.map(function (item) {
				return item.selected;
			}));
			var klass = (0, _classnames2.default)('ola-results', categories.map(function (item) {
				return 'ola-section-' + (0, _utilities.generateSlug)(item);
			}));
