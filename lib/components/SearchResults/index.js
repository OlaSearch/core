...
var SearchResults = function (_React$Component) {
  ...
  SearchResults.prototype.render = function render() {
    var _props = this.props,
        ...
        theme = _props.theme,
        rest = (0, _objectWithoutProperties3['default'])(_props, ['results', 'className', 'snippet', 'theme']);
    ...
    return _react2['default'].createElement(
      'div',
      {
        className: _style2['default'].dynamic([['990041512', [theme.searchLinkColor, theme.searchLinkHoverColor, theme.primaryButtonColor, theme.primaryButtonBackground, theme.shareButtonColor, theme.shareButtonBackground, theme.primaryColor, theme.primaryColor, theme.primaryColor]]]) + ' ' + (klass || '')
      },
...
module.exports = (0, _withTheme2['default'])(SearchResults);