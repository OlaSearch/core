...
var DocumentPages = function (_React$Component) {
  ...
  function DocumentPages(props) {
    ...
    _this.onSelect = function (pageNumber) {
      _this.props.onClick && _this.props.onClick(pageNumber, _this.props.result);
    };
  ...
  require('../../../.babelhelper.js').createClass(DocumentPages, [{
    ...
    value: function render() {
      ...
      if (!isVisible) return _react2['default'].createElement(
        'div',
