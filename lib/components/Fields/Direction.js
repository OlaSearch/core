...
var Directions = function Directions(props) {
  var latlong = props.latlong,
      ...
      rest = (0, _objectWithoutProperties3['default'])(props, ['latlong', 'translate', 'label', 'iconLeft', 'iconRight', 'onClick', 'result', 'log', 'fieldLabel']);
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      'a',
      (0, _extends3['default'])({ className: 'ola-btn ola-btn-directions',
        onClick: handleClick,
        href: url
      }, rest),
      iconLeft,
