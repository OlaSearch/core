...
var Phone = function Phone(props) {
  ...
  var snippetId = props.snippetId;
  var collectionId = props.collectionId;

  var rest = require('../../../.babelhelper.js').objectWithoutProperties(props, ['phone', 'label', 'translate', 'log', 'onClick', 'result', 'snippetId', 'collectionId']);
