...
function Thumbnail(props) {
  var thumbnail = props.thumbnail,
      ...
      result = props.result,
      config = props.config,
      rest = (0, _objectWithoutProperties3['default'])(props, ['thumbnail', 'baseUrl', 'isLink', 'url', 'log', 'useBackgroundImage', 'logPayload', 'snippetId', 'result', 'config']);
  var mediaQuery = config.mediaQuery,
      cdn = config.cdn;


  var restProps = (0, _omit2['default'])(['size', 'collectionId', 'showIfEmpty'], rest);
...
module.exports = (0, _withConfig2['default'])((0, _withLogger2['default'])(Thumbnail));