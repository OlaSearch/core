...
function Thumbnail(props, context) {
  ...
  var thumbnail = props.thumbnail,
      ...
      result = props.result,
      rest = (0, _objectWithoutProperties3['default'])(props, ['thumbnail', 'baseUrl', 'isLink', 'url', 'log', 'useBackgroundImage', 'logPayload', 'snippetId', 'result']);
...
module.exports = (0, _withLogger2['default'])(Thumbnail);