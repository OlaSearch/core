  ...
  require('../../../.babelhelper.js').createClass(Title, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        iconLeft,
        isLink ? _react2['default'].createElement('a', { href: url, target: this.props.target, onClick: this.logClick, dangerouslySetInnerHTML: (0, _utilities.createHTMLMarkup)(title) }) : _react2['default'].createElement('span', { dangerouslySetInnerHTML: (0, _utilities.createHTMLMarkup)(title) }),
        children,
        iconRight
      );
    }
