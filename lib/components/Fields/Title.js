...
var Title = function (_React$Component) {
  ...
  _createClass(Title, [{
    ...
    value: function render() {
      ...
      var rest = _objectWithoutProperties(_props, ['result', 'isLink', 'children', 'baseUrl', 'url']);
      ...
      if (highlighting) {
        ...
        if ((typeof highlightedTitle === 'undefined' ? 'undefined' : _typeof(highlightedTitle)) === 'object') title = highlightedTitle[0];
      }

      return _react2['default'].createElement(
        'h3',
        _extends({ className: 'ola-field ola-field-title' }, rest),
        iconLeft,
