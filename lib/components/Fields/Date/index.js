...
function DateField(_ref) {
   ...
   */
  if (endDate) {
    fallsOnSameDay = (0, _dateParser.isSameDay)(date, endDate);
    if (fallsOnSameDay) {
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        formattedEndDate ? formattedEndDate === formattedDate ? formattedDate : fallsOnSameDay ? (0, _dateParser.format)(date, format) + ', ' + (0, _dateParser.format)(date, timeFormat) + ' - ' + (0, _dateParser.format)(endDate, timeFormat) : formattedDate + ' - ' + formattedEndDate : formattedDate
      )
    )
  );
}
