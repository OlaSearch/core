...
function Directions(props) {
  var translate = props.translate,
      ...
      rest = (0, _objectWithoutProperties3['default'])(props, ['translate', 'locationName', 'label', 'iconSize', 'iconRight', 'onClick', 'result', 'log', 'fieldLabel', 'snippetId', 'showIfEmpty', 'distanceFieldName', 'locationFieldName', 'collectionId', 'displayIcon', 'logPayload']);
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      ...
      locationName && _react2['default'].createElement(
        ...
        (0, _utilities.getDisplayName)(locationName),
        ' ',
