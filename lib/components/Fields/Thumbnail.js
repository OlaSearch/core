...
function Thumbnail(props, context) {
  ...
  var thumbnail = props.thumbnail,
      ...
      rest = (0, _objectWithoutProperties3['default'])(props, ['thumbnail', 'thumbnail_mobile', 'baseUrl', 'isLink', 'url', 'log', 'useBackgroundImage']);
  ...
  var imgThumbnail = useBackgroundImage ? _react2['default'].createElement('div', (0, _extends3['default'])({ className: 'ola-img ola-img-bg' }, restProps, { style: { backgroundImage: 'url(' + imageUrl + ')' } })) : _react2['default'].createElement('img', (0, _extends3['default'])({ className: 'ola-img' }, restProps, { src: '' + baseUrl + thumbnail, alt: '' }));
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(
      ...
      _react2['default'].createElement('img', (0, _extends3['default'])({ className: 'ola-img ola-img-mobile' }, restProps, { src: '' + baseUrl + thumbnailMobile, alt: '' }))
    )
  );
}
