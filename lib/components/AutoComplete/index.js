...
var AutoComplete = function (_React$Component) {
  ...
  function AutoComplete(props) {
      ...
      if (allowedCharacters && !(0, _utilities.checkForAllowedCharacters)(term, allowedCharacters)) {
        ...
        _this.props.executeFuzzyAutoSuggest(term).then(function (results) {
          ...
          for (var i = 0, len = results.length; i < len; i++) {
            ...
            var topClickDocs = topClicks && topClicks.length ? topClicks.map(function (item) {
              return (0, _extends3['default'])({ term: item.title, type: OLA_DOC_TYPE }, item);
            }) : [];
            ...
            if (isCategory) {
              ...
              res = [].concat((0, _toConsumableArray3['default'])(res), [(0, _extends3['default'])({}, rest, {
                suggestion_raw: payload.suggestion_raw,
                label: payload.label,
                answer: payload.answer,
                type: payload.type /* The first item is a query */
              })], (0, _toConsumableArray3['default'])(topClickDocs));
              ...
              res = [].concat((0, _toConsumableArray3['default'])(res), [(0, _extends3['default'])({}, rest, payload)], (0, _toConsumableArray3['default'])(topClickDocs));
            }
          }
    ...
    _this.onKeyDown = function (direction) {
      ...
      term && term.type !== OLA_DOC_TYPE && _this.updateFuzzyQueryTerm(term);
    ...
    _this.onFuzzySelect = function (suggestion, options) {
      ...
      if (isEntity || isTaxonomy) {
        ...
        if (suggestion.taxo_label && suggestion.taxo_term) {
          ...
          _this.props.updateQueryTerm(path || term);
        }
      }
            ...
            _react2['default'].createElement(
              ...
              showSuggestionHelp ? _react2['default'].createElement(
                ...
                q ? translate('autosuggest_help') : _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    'a',
                    { onClick: this.props.clearHistory, className: 'ola-suggestions-clear' },
                    'clear'
                  )
                )
              ) : null,
