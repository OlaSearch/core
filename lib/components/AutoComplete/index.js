...
var AutoComplete = function (_React$Component) {
  ...
  function AutoComplete(props) {
    ...
    _this.onFuzzySelect = function (suggestion) {
      ...
      var term = suggestion.term;
      var taxoGroup = payload.taxo_group;
      var taxo_id = payload.taxo_id;
      /* If onSelect prop is set */
      ...
      if (_this.props.onSelect) {
        ...
        return _this.props.onSelect(suggestion);
      }
      ...
      var url = void 0;
      if (taxoGroup) {
        url = (0, _urlSync.buildQueryString)({ facet_query: [{ name: taxoGroup, selected: taxo_id }] });
      } else {
        url = (0, _urlSync.buildQueryString)({ q: term });
      }
      window.location.href = searchPageUrl + (0, _urlSync.getHistoryCharacter)(history) + url;
    };
