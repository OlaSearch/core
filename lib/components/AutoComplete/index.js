      ...
      if (allowedCharacters && !(0, _utilities.checkForAllowedCharacters)(term, allowedCharacters)) {
        ...
        _this.props.executeFuzzyAutoSuggest(term).then(function (results) {
          ...
          for (var i = 0, len = results.length; i < len; i++) {
            ...
            var hasTopClicks = topClicks && topClicks.length;
            ...
            if (isCategory) {
              ...
              if (topClicks) {
                res = [].concat((0, _toConsumableArray3['default'])(res), (0, _toConsumableArray3['default'])(topClicks.map(function (item) {
                  return (0, _extends3['default'])({ term: item.title, type: 'doc' }, item);
                })));
              }
