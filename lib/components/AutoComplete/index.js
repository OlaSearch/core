  ...
  function AutoComplete(props) {
    ...
    _this.clearQueryTerm = function (cb) {
      _this.setState({
        q: '',
        fuzzyQuery: null,
        results: (0, _utilities.mergeResultsWithHistory)(_this.props.history, []),
    ...
    _this.handleHistoryChange = function (newHistory) {
      _this.setState({
        results: (0, _utilities.mergeResultsWithHistory)(newHistory, [])
      });
    };
    ...
    _this.onChange = function (term, searchInput) {
      ...
      if (allowedCharacters && !(0, _utilities.checkForAllowedCharacters)(term, allowedCharacters)) {
        ...
        _this.props.executeFuzzyAutoSuggest(term).then(function (results) {
          ...
          _this.setState({
            results: (0, _utilities.mergeResultsWithHistory)(_this.props.history, res, _this.state.q),
    ...
    _this.onFocus = function (event) {
      ...
      _this.setState({
        isFocused: true,
        isOpen: true,
        results: (0, _utilities.mergeResultsWithHistory)(_this.props.history, _this.state.results, _this.state.q)
      });
