...
var AutoComplete = function (_React$Component) {
  ...
  function AutoComplete(props) {
          ...
          for (var i = 0; i < results.length; i++) {
            ...
            if (payload.categories && !categoryFound) {
              ...
              for (var j = 0; j < totalCategories; j++) {
                ...
                var _payload$categories$j2 = require('../../../.babelhelper.js').slicedToArray(_payload$categories$j, 2);

                var name = _payload$categories$j2[0];
                var count = _payload$categories$j2[1];
    ...
    _this.onFuzzySelect = function (suggestion) {
      ...
      var taxo_group = payload.taxo_group;
