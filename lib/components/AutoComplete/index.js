...
var _ref7 = _react2['default'].createElement(_QueryHelp2['default'], null);
...
var AutoComplete = function (_React$Component) {
  ...
  function AutoComplete(props) {
    ...
    _this.updateFuzzyQueryTerm = function (fuzzyQuery) {
      _this.setState({
        ...
        var tokenIndex = _this.state.startToken + fuzzyQuery.term.length;
    ...
    _this.onChange = function (event, searchInput) {
      ...
      if (allowedCharacters && !(0, _utilities.checkForAllowedCharacters)(term, allowedCharacters)) {
        ...
        ajaxRequest.then(function (results) {
          if (!results) return;
          /* Prepare results */
          var res = (0, _utilities.getAutoCompleteResults)(results, _this.context.config.facets, showWordSuggestion, _this.props.tokens);
    ...
    _this.updateCursor = function (start) {
      setTimeout(function () {
        return _this.inputEl.input._input.setSelectionRange(start, start);
      });
    };
    ...
    _this.onSubmit = function (event, options) {
      ...
      if (_this.props.tokens.length) {
        _this.props.tokens.forEach(function (_ref5) {
          ...
          var facet = (0, _find2['default'])((0, _propEq2['default'])('name', name))(_this.context.config.facets);
    ...
    _this.onFuzzySelect = function (suggestion, options) {
      ...
      if (isFacet) {
        ...
        _this.props.addToken({
          ...
          endToken: _this.state.startToken + suggestion.term.length,
          isHidden: true,
      ...
      if (isQuery || isHistory) {
        ...
        if (suggestion.tokens) {
          ...
          for (var i = 0; i < suggestion.tokens.length; i++) {
            facet = (0, _find2['default'])((0, _propEq2['default'])('name', suggestion.tokens[i].name))(_this.context.config.facets);
            _this.props.replaceFacet(facet, suggestion.tokens[i].value);
          }
        }
        _this.props.updateQueryTerm(term, _Settings.SEARCH_INPUTS.SUGGESTION);
      }
  ...
  AutoComplete.prototype.render = function render() {
    ...
    var queryTerm = fuzzyQuery ? showWordSuggestion ? q.substr(0, startToken) + fuzzyQuery.term + q.substr(endToken) || q : fuzzyQuery.term : q;
    ...
    return _react2['default'].createElement(
      ...
      function (theme) {
        return _react2['default'].createElement(
          'div',
          { ref: _this2.registerEl, className: _style2['default'].dynamic([['3591991043', [theme.primaryColor]]]) + ' ' + (klassContainer || '')
          },
          _react2['default'].createElement(
            'div',
            {
              className: _style2['default'].dynamic([['3591991043', [theme.primaryColor]]]) + ' ' + (_this2.props.containerClass || '')
            },
            _react2['default'].createElement(_Input2['default'], {
              q: queryTerm,
              ref: _this2.registerInput,
              onChange: _this2.onChange,
              onClear: _this2.clearQueryTerm,
              onKeyDown: _this2.onKeyDown,
              onSubmit: _this2.onSubmit,
              onFocus: _this2.onFocus,
              isOpen: isOpen,
              placeholder: translate('autosuggest_placeholder'),
              handleClickOutside: _this2.handleClickOutside,
              onSearchButtonClick: _this2.onSubmit,
              results: results,
              showZone: showZone,
              fuzzyQuery: fuzzyQuery,
              showGeoLocation: _this2.props.showGeoLocation,
              onGeoLocationSuccess: _this2.props.onGeoLocationSuccess,
              onGeoLocationDisable: _this2.props.onGeoLocationDisable,
              refreshOnGeoChange: _this2.props.refreshOnGeoChange,
              autoFocus: _this2.props.autoFocus,
              isPhone: _this2.props.isPhone,
              onBlur: _this2.onSoftBlur,
              handleClose: _this2.terminateAutoSuggest,
              tokens: _this2.props.tokens,
              onTokenChange: _this2.onTokenChange,
              showWordSuggestion: showWordSuggestion,
              showAlert: _this2.props.showAlert,
            ...
            _react2['default'].createElement(
              'div',
              {
                style: {
                  left: leftPosition,
                  width: showWordSuggestion ? _this2.props.wordSuggestionWidth : 'auto'
                },
                className: _style2['default'].dynamic([['3591991043', [theme.primaryColor]]]) + ' ' + (klass || '')
              },
              _react2['default'].createElement(
                'div',
                { ref: _this2.registerRef, className: _style2['default'].dynamic([['3591991043', [theme.primaryColor]]]) + ' ' + 'ola-suggestions-wrapper'
                },
                showSuggestionHelp ? _react2['default'].createElement(
                  'div',
                  {
                    className: _style2['default'].dynamic([['3591991043', [theme.primaryColor]]]) + ' ' + 'ola-suggestions-help'
                  },
                  q ? showWordSuggestion ? null : translate('autosuggest_help') : _react2['default'].createElement(
                    'span',
                    {
                      className: _style2['default'].dynamic([['3591991043', [theme.primaryColor]]])
                    },
                    translate('autosuggest_help_history'),
                    _react2['default'].createElement(
                      'a',
                      {
                        onClick: _this2.props.clearHistory,
                        className: _style2['default'].dynamic([['3591991043', [theme.primaryColor]]]) + ' ' + 'ola-suggestions-clear'
                      },
                ...
                _react2['default'].createElement(_FuzzySuggestions2['default'], {
                  results: results,
                  onSelect: _this2.onFuzzySelect,
                  onRemoveHistory: _this2.onRemoveHistory,
                  activeClassName: _this2.props.activeClassName,
                  fieldLabels: _this2.context.config.fieldLabels,
                  q: q
                })
              )
            ),
            !isOpen && isFocused && !queryTerm && _this2.props.showHelp && _ref7
          ),
...
})((0, _withTranslate2['default'])((0, _reactOnclickoutside2['default'])(AutoComplete)));