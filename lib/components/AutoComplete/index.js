...
var AutoComplete = function (_React$Component) {
  ...
  function AutoComplete(props) {
    ...
    _this.mergeWithHistory = function () {
      var results = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var limit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3;
      var nextHistory = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      ...
      var userQuery = _this.state.q;
      var history = nextHistory || _this.props.history;
      /* Remove duplicate terms from history */
      history = history.map(function (_ref) {
        var q = _ref.q,
            dateAdded = _ref.dateAdded;
        return { term: q.toLowerCase(), type: 'history', dateAdded: dateAdded };
      }).filter(function (his) {
      ...
      if (userQuery) {
        ...
        history = history.filter(function (_ref2) {
          var term = _ref2.term;
          return term.match(new RegExp('^' + _this.state.q, 'gi'));
        }).sort(function (a, b) {
          /* Sort by match */
          var q = _this.state.q;
    ...
    _this.updateResults = function (results) {
      var _results = _this.mergeWithHistory(results);
      _this.setState({
        results: _results,
        isOpen: _this.state.q ? !!_results.length : false
      });
    };
    ...
    _this.onChange = function (term, searchInput) {
      ...
      if (!term) {
        return _this.clearQueryTerm(function () {
          var history = _this.mergeWithHistory([], 5);
          _this.setState({
            results: history,
          ...
          for (var i = 0, len = results.length; i < len; i++) {
            ...
            if (isCategory) {
              ...
              for (var j = 0; j < totalCategories; j++) {
                ...
                var _ref5 = payload.taxo_paths ? payload.taxo_paths[j].split('|') : [],
    ...
    _this.onClear = function (cb) {
      _this.clearQueryTerm(cb);
    };
  ...
  (0, _createClass3['default'])(AutoComplete, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.history !== this.props.history) {
        var history = this.mergeWithHistory([], 5, nextProps.history);
        this.setState({
          results: history
        });
      }
    ...
    value: function render() {
      ...
      var klass = (0, _classnames2['default'])('ola-suggestions', {
        'ola-js-hide': !isOpen
      });
