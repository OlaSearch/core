...
var _ref5 = _react2['default'].createElement(_QueryHelp2['default'], null);
  ...
  function AutoComplete(props) {
    ...
    _this.onSubmit = function (event, options) {
      ...
      if (_this.props.tokens.length) {
        _this.props.tokens.forEach(function (_ref4) {
  ...
  AutoComplete.prototype.render = function render() {
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        !isOpen && isFocused && !queryTerm && this.props.showHelp && _ref5
      )
    );
  };
