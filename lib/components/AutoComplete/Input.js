...
var Input = function (_React$Component) {
  ...
  function Input() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.onClear = function (event) {
      ...
      var terms = tokens.map(function (_ref) {
        ...
        return (0, _utilities.getDisplayName)(value);
  ...
  Input.prototype.render = function render() {
    ...
    var classes = (0, _classnames2['default'])('ola-search-form-container', {
    ...
    return _react2['default'].createElement(
      'div',
      {
        className: _style2['default'].dynamic([['2773465320', [this.props.theme.primaryColor, this.props.theme.primaryColor]]]) + ' ' + (classes || '')
      },
