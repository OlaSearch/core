...
var Input = function (_React$Component) {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Input)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onClear = function (event) {
      ...
      switch (event.which) {
        ...
        case 39:
           ...
           */
          if (!_this.props.results.length || _this.props.fuzzyQuery) return;
          var firstTerm = _this.props.results[0].suggestion;
          return _this.props.onChange(firstTerm);
  ...
  require('../../../.babelhelper.js').createClass(Input, [{
    ...
    value: function render() {
      ...
      var fuzzyQuery = _props.fuzzyQuery;
      ...
      var _first = !fuzzyQuery && q && results.length ? results[0].suggestion : '';
