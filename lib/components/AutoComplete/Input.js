...
var _ref = _react2['default'].createElement(_History2['default'], null);
...
var Input = function (_React$Component) {
  ...
  function Input() {
    ...
    return _ret = (_temp = (_this = require('../../../.babelhelper.js').possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Input)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onClear = function (event) {
      ...
      /* Scroll to input */
      if (_this.props.isPhone) (0, _utilities.scrollTo)(_this.refs.Input);
      ...
      switch (event.which) {
        ...
        case 27:
          ...
          if (!isOpen) return _this.refs.Input.select();
