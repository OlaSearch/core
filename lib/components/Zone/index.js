...
function Zone(props) {
  function onChange(event) {
    ...
    var facet = createZoneFacet(props.config.zone.filter);
    if (value) {
  ...
  var _props$config$zone = props.config.zone,
      defaultValue = _props$config$zone.defaultValue,
      values = _props$config$zone.values,
      filter = _props$config$zone.filter;
...
module.exports = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)((0, _withConfig2['default'])(Zone));