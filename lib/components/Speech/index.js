...
var SpeechInput = function (_React$Component) {
  ...
  SpeechInput.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    return nextState.isRecording !== this.state.isRecording;
  };

  SpeechInput.prototype.render = function render() {
    var _state = this.state,
        isRecording = _state.isRecording,
        isSpeechSupported = _state.isSpeechSupported;
    var translate = this.props.translate;
    var voiceSearch = this.props.config.voiceSearch;
...
module.exports = (0, _withLogger2['default'])((0, _withConfig2['default'])((0, _withTranslate2['default'])(SpeechInput)));