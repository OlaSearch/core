...
function persistState(action, getState, namespace) {
  ...
  switch (action.type) {
    ...
    case _ActionTypes2['default'].REMOVE_BOOKMARK:
      return _storage2['default'].set(_Settings.BOOKMARKS_STORAGE_KEY, state.AppState.bookmarks, namespace);
    ...
    case _ActionTypes2['default'].REMOVE_HISTORY:
      return _storage2['default'].set(_Settings.HISTORY_STORAGE_KEY, state.AppState.history, namespace);

    case _ActionTypes2['default'].SET_LOCALE:
      return _storage2['default'].cookies.set(_Settings.LOCALE_STORAGE_KEY, action.locale, _Settings.LOCALE_STORAGE_TTL, namespace);
    ...
    case _ActionTypes2['default'].ADD_CONTEXT_FIELD:
      return _storage2['default'].cookies.set(_Settings.CONTEXT_STORAGE_KEY, state.Context, _Settings.CONTEXT_STORAGE_TTL, namespace);
  }
}