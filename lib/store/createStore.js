...
module.exports = function (config, searchProvider) {
  ...
  if (process.env.NODE_ENV === 'production') {
    store = (0, _redux.createStore)(olaReducers, _redux.compose.apply(undefined, [_redux.applyMiddleware.apply(undefined, [_reduxThunk2['default'], olaMiddleWare].concat((0, _toConsumableArray3['default'])(middlewares)))].concat((0, _toConsumableArray3['default'])(enhancers))));
  } else {
    ...
    store = (0, _redux.createStore)(olaReducers, _redux.compose.apply(undefined, [_redux.applyMiddleware.apply(undefined, [_reduxThunk2['default'], olaMiddleWare, logger].concat((0, _toConsumableArray3['default'])(middlewares))), window.devToolsExtension ? window.devToolsExtension() : function (f) {
      return f;
    }].concat((0, _toConsumableArray3['default'])(enhancers))));
  }
