  ...
  return function (_ref) {
    ...
    return function (next) {
      return function (action) {
        ...
        var params = proxy ? (0, _extends3['default'])({}, query, payload.extraParams, payload.answer ? { answer: payload.answer } : {}, { api: api }, context, { projectId: projectId, env: env }) : api === _Settings.FUZZY_SUGGEST_KEY ? query : queryBuilder.transform(query, mapping, acl, context);
