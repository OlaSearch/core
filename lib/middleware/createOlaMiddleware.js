  ...
  return function (_ref) {
    ...
    return function (next) {
      return function (action) {
        ...
        var _action$nullResponse = action.nullResponse;
        var nullResponse = _action$nullResponse === undefined ? null : _action$nullResponse;
        ...
        var _action$returnWithout = action.returnWithoutDispatch;
        var returnWithoutDispatch = _action$returnWithout === undefined ? false : _action$returnWithout;
        ...
        var params = proxy ? require('../../.babelhelper.js')['extends']({}, query, payload.answer ? { answer: payload.answer } : {}, { api: api }, context) : queryBuilder.transform(query, mapping, acl, context);
