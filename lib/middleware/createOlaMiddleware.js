  ...
  return function (_ref) {
    ...
    return function (next) {
      return function (action) {
        ...
        shouldDispatchActions && next(_extends({}, payload, {
          type: requestType
        }));
        ...
        var params = proxy ? _extends({}, query, payload.answer ? { answer: payload.answer } : {}, { api: api }, context, { projectId: projectId, env: env }) : api === FUZZY_SUGGEST_KEY ? query : queryBuilder.transform(query, mapping, acl, context);
        ...
        if (typeof api === 'function') {
          ...
          callApi = function callApi() {
            return searchService.hasOwnProperty(api) ? searchService[api](timestampObj, params, apiUrl, intentEngineEnabled) : null;
          };
        }
