  ...
  return function (_ref) {
    ...
    return function (next) {
      return function (action) {
        ...
        var params = proxy ? _extends({}, query, payload.extraParams, payload.answer ? { answer: payload.answer } : {}, { api: api }, context, { projectId: projectId, env: env }) : api === FUZZY_SUGGEST_KEY ? query : queryBuilder.transform(query, mapping, acl, context
