      ...
      return function (action) {
        ...
        return callApi.then(function (xhr) {
          ...
          if (!bot /* Do not fill facet_query if its from bot */ && answer && answer.search && answer.search.facet_query && answer.search.facet_query.length) {
            ...
            var answerFacetNames = answerFacets.map(function (_ref2) {
              var name = _ref2.name;
              return name;
            });
            /**
             ...
             */
            facetQuery = facetQuery.filter(function (_ref3) {
            ...
            var _loop = function _loop(i) {
              ...
              var exists = facetQuery.some(function (_ref4) {
           ...
           */
          if (totalResults === 0 && spellSuggestions.length && !enrichedQuery && !(answer && answer.intent && _Settings.IGNORE_INTENTS.indexOf(answer.intent) === -1) && !currentState.QueryState.skip_spellcheck) {
