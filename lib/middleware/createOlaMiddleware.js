    ...
    return function (next) {
      return function (action) {
        ...
        return callApi.then(function (xhr) {
          ...
          if (bot && intentEngineEnabled && _Settings.INTENT_SUPPORTED_API_KEYS.indexOf(api) !== -1 && (!answer || answer.error || answer && !answer.reply && !answer.search && !answer.card && !answer.location)) {
