  ...
  return function (_ref) {
    ...
    return function (next) {
      return function (action) {
        ...
        var callApi = void 0;
        var params = proxy ? _extends({}, query, { api: api }) : queryBuilder.transform(query, api === 'suggest' ? config.mappingAutoSuggest : null, acl);
        ...
        return callApi().then(function (response, xhr) {
          ...
          if (!proxy) {
            ...
            var spellSuggestions = response.spellSuggestions;
