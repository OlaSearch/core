      ...
      return function (action) {
        ...
        if (typeof api === 'function') {
          ...
          switch (api) {
            case 'suggest':
              callApi = function callApi() {
                return searchService[api](params, config.mappingAutoSuggest);
              };
              break;

            case 'get':
              callApi = function callApi() {
                return searchService[api](params);
              };
              break;
            ...
            default:
              callApi = function callApi() {
                return searchService.hasOwnProperty(api) ? searchService[api](params) : null;
              };
              break;
          }
        }
