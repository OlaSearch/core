...
var _persistState = require('./../services/persistState');
  ...
  return function (_ref) {
    ...
    return function (next) {
      return function (action) {
        ...
        next(require('../../.babelhelper.js')['extends']({}, payload, {
          type: requestType
        }));
        ...
        var callApi = void 0;
        var params = proxy ? require('../../.babelhelper.js')['extends']({}, query, { api: api }) : queryBuilder.transform(query, api === 'suggest' ? config.mappingAutoSuggest : null, acl, context);
