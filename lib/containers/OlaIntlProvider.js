...
var OlaIntlProvider = function (_React$Component) {
  ...
  _createClass(OlaIntlProvider, [{
    ...
    value: function getChildContext() {
      ...
      var _props$translations = _props.translations;
      var t = _props$translations === undefined ? {} : _props$translations;

      return {
        translations: {
          locales: t[locale] ? t[locale]['locales'] : _translations2['default'][locale]['locales'],
          messages: Object.assign({}, _translations2['default'][locale]['messages'], t[locale] ? t[locale]['messages'] : {})
        }
      };
    }
  }, {
