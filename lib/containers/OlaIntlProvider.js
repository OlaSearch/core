...
var OlaIntlProvider = function (_React$Component) {
  ...
  function OlaIntlProvider(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OlaIntlProvider).call(this, props));
    ...
    _this.messages = Object.assign({}, _translations2['default'][locale]['messages'], t[locale] ? t[locale]['messages'] : {});
    return _this;
  }
