...
var baseTranslations = _interopRequireWildcard(_translations);
...
var OlaIntlProvider = function (_React$Component) {
  ...
  function OlaIntlProvider(props) {
    ...
    var locale = props.locale,
        ...
        translations = _props$translations === undefined ? {} : _props$translations;

    _this.messages = (0, _extends3['default'])({}, baseTranslations[locale] ? baseTranslations[locale]['messages'] : {}, translations[locale] ? translations[locale]['messages'] : {});
    return _this;
  }

  OlaIntlProvider.prototype.getChildContext = function getChildContext() {
    return {
      translate: this.translate
    };
  };

  OlaIntlProvider.prototype.render = function render() {
...
exports['default'] = (0, _reactRedux.connect)(mapPropsToState)(OlaIntlProvider);