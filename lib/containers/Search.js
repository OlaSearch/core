...
var Search = function (_React$Component) {
  ...
  function Search(props) {
    ...
    var _this = require('../../.babelhelper.js').possibleConstructorReturn(this, Object.getPrototypeOf(Search).call(this, props));
  ...
  require('../../.babelhelper.js').createClass(Search, [{
    ...
    value: function render() {
      ...
      var q = QueryState.q;
      var facetQuery = QueryState.facet_query;
      var page = QueryState.page;
      var perPage = QueryState.per_page;
