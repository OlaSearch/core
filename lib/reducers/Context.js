...
exports['default'] = function () {
  ...
  switch (action.type) {
    ...
    case _ActionTypes2['default'].ADD_FACET:
      return require('../../.babelhelper.js')['extends']({}, state, {
        filter_sequence: [].concat(require('../../.babelhelper.js').toConsumableArray(state.filter_sequence), [action.facet.name + ':' + action.value])
      });

    case _ActionTypes2['default'].REMOVE_FACET:
      return require('../../.babelhelper.js')['extends']({}, state, {
        filter_sequence: state.filter_sequence.filter(function (item) {
