...
exports['default'] = function () {
  ...
  switch (action.type) {
    ...
    case _ActionTypes2['default'].REQUEST_GEO_LOCATION_SUCCESS:
      ...
      _storage2['default'].cookies.set(_Settings.CONTEXT_STORAGE_KEY, _state, _Settings.CONTEXT_STORAGE_TTL);
      return _state;
    ...
    case _ActionTypes2['default'].ADD_CONTEXT:
      ...
      _storage2['default'].set(_Settings.CONTEXT_STORAGE_KEY, _state, _Settings.CONTEXT_STORAGE_TTL);
      return _state;
