  ...
  switch (action.type) {
    case _ActionTypes2['default'].ADD_FILTER:
      ...
      if (exists) {
        ...
        return (0, _extends3['default'])({}, state, {
          filters: [].concat(state.filters, [(0, _extends3['default'])({}, filter, { selected: selected })])
        });
      }
    ...
    case _ActionTypes2['default'].SET_SKIP_SPELLCHECK:
      return (0, _extends3['default'])({}, state, {
    ...
    case _ActionTypes2['default'].ADD_FACET:
      ...
      if (exists) {
        return (0, _extends3['default'])({}, state, {
          ...
          facet_query: state.facet_query.map(function (item) {
            if (item.name === action.facet.name) {
              return (0, _extends3['default'])({}, item, {
                selected: [].concat(item.selected, [action.value])
              });
            }
            return item;
          })
        ...
        return (0, _extends3['default'])({}, state, {
          page: 1,
          facet_query: [].concat(state.facet_query, [(0, _extends3['default'])({}, action.facet, {
    ...
    case _ActionTypes2['default'].REMOVE_FACET:
      return (0, _extends3['default'])({}, state, {
        ...
        tokens: state.tokens.filter(function (_ref) {
          var value = _ref.value;
          return value !== action.value;
        })
      });

    case _ActionTypes2['default'].REMOVE_INTENT_ENGINE_FACETS:
      return (0, _extends3['default'])({}, state, {
        facet_query: state.facet_query.filter(function (item) {
          return !('fromIntentEngine' in item);
        })
      });
    ...
    case _ActionTypes2['default'].ADD_TOKEN:
      return (0, _extends3['default'])({}, state, {
        tokens: [].concat(state.tokens, [action.options])
      });

    case _ActionTypes2['default'].REMOVE_TOKEN:
      return (0, _extends3['default'])({}, state, {
        tokens: state.tokens.filter(function (_ref2) {
          var value = _ref2.value;
          return value !== action.value;
        })
      });

    case _ActionTypes2['default'].REPLACE_TOKENS:
      return (0, _extends3['default'])({}, state, {
        tokens: action.tokens,
        facet_query: state.facet_query.filter(function (_ref3) {
          var isToken = _ref3.isToken;
          return !isToken;
        })
      });

    case _ActionTypes2['default'].REMOVE_ALL_TOKENS:
      return (0, _extends3['default'])({}, state, {
        tokens: []
      });

    case _ActionTypes2['default'].REMOVE_TOKEN_FACETS:
      return (0, _extends3['default'])({}, state, {
    ...
    case _ActionTypes2['default'].REQUEST_SEARCH_SUCCESS:
      return (0, _extends3['default'])({}, state, {
        ...
        sort: action.sortCondition || state.sort /* Fix bug where sort persists */
        , facet_query: action.facetQuery || state.facet_query /* From intent engine */
        , source: null
      });
    ...
    case _ActionTypes2['default'].OLA_REHYDRATE:
      return (0, _extends3['default'])({}, state, {
        ...
        env: action.env,
        per_page: action.configState ? action.configState.perPage : initialState.per_page,
        debug: action.debug
      });
    ...
    case _ActionTypes2['default'].ADD_SKIP_FACET_FIELDS:
      return (0, _extends3['default'])({}, state, {
        skip_facet_fields: [].concat(state.skip_facet_fields, [action.facet.name])
      });

    case _ActionTypes2['default'].REMOVE_SKIP_FACET_FIELDS:
      return (0, _extends3['default'])({}, state, {
        skip_facet_fields: state.skip_facet_fields.filter(function (name) {
          return name !== action.name;
        })
      });

    case _ActionTypes2['default'].CLEAR_SKIP_FACET_FIELDS:
      return (0, _extends3['default'])({}, state, {
        skip_facet_fields: []
      });
