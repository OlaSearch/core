...
exports['default'] = function () {
  ...
  var _ret = function () {
    switch (action.type) {
      case _ActionTypes2['default'].ADD_FILTER:
        ...
        if (exists) {
          return {
            v: require('../../.babelhelper.js')['extends']({}, state, {
      ...
      case _ActionTypes2['default'].UPDATE_STATE_FROM_QUERY:
        ...
        return {
          v: require('../../.babelhelper.js')['extends']({}, state, action.stateFromUrl, {
            referrer: '',
      ...
      case _ActionTypes2['default'].UPDATE_OLA_PARAMETERS:
        return {
          v: require('../../.babelhelper.js')['extends']({}, state, action.params)
        };
  ...
  if ((typeof _ret === 'undefined' ? 'undefined' : require('../../.babelhelper.js')['typeof'](_ret)) === "object") return _ret.v;
};