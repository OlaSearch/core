...
exports['default'] = function () {
  ...
  switch (action.type) {
    ...
    case _ActionTypes2['default'].ADD_HISTORY:
      ...
      var query = (0, _ramda.omit)(['page', 'per_page', 'referrer'], action.query);
      ...
      var activeFacets = (0, _ramda.flatten)(facet_query.map(function (item) {
      ...
      var exists = state.history.filter(function (item) {
        return item.q === q && (0, _ramda.equals)(item.facets, activeFacets);
      });
