...
exports['default'] = function () {
  ...
  switch (action.type) {
    ...
    case _ActionTypes2['default'].OLA_REHYDRATE:
       ...
       */
      var configState = action.configState,
          storeState = action.storeState,
          _namespace = action.namespace;

      return (0, _extends4['default'])({}, state, action.storeState, { /* Includes bookmarks, history */
        view: storeState && storeState.view /* Results view grid|list */
        ? storeState.view : initialState.view,
        namespace: _namespace /* Project namespace */
        , allowedCharacters: configState /* Allowed characters in the query */
        ? configState.allowedCharacters : state.allowedCharacters,
        replaceQueryParamName: configState ? configState.replaceQueryParamName : state.replaceQueryParamName,
        showSidebar: configState ? configState.sidebar : state.showSidebar,
        layoutSwitching: configState ? configState.layoutSwitching : state.layoutSwitching,
        filterInAutoComplete: configState ? configState.filterInAutoComplete : state.filterInAutoComplete,
        /**
         ...
         *   : false
         */
        isSidebarOpen: action.configState ? configState.sidebar ? storeState.isSidebarOpen : false : state.isSidebarOpen
      });
