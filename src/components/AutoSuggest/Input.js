...
class Input extends React.Component {
  ...
  render () {
    ...
    var button = q
      ? <button type='reset' className='ola-clear-button' onMouseDown={this.onClear}></button>
      : <button type='button' className='ola-search-button' onMouseDown={this.onSearchButtonClick} />
